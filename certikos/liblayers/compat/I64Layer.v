...
Context {D: compatdata}.
  ...
  Inductive sextcall_longuoffloat_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_longuoffloat_step_intro
      x z
      (Hxz: Val.longuoffloat x = Some z)
      m :
      sextcall_longuoffloat_step (x :: nil) m z m
  .
  ...
  Inductive sextcall_floatoflong_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_floatoflong_step_intro
      x z
      (Hxz: Val.floatoflong x = Some z)
      m :
      sextcall_floatoflong_step (x :: nil) m z m
  .
  ...
  Inductive sextcall_floatoflongu_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_floatoflongu_step_intro
      x z
      (Hxz: Val.floatoflongu x = Some z)
      m :
      sextcall_floatoflongu_step (x :: nil) m z m
  .
  ...
  Inductive sextcall_singleoflong_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_singleoflong_step_intro
      x z
      (Hxz: Val.singleoflong x = Some z)
      m :
      sextcall_singleoflong_step (x :: nil) m z m
  .
  ...
  Inductive sextcall_singleoflongu_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_singleoflongu_step_intro
      x z
      (Hxz: Val.singleoflongu x = Some z)
      m :
      sextcall_singleoflongu_step (x :: nil) m z m
  .
  ...
  Inductive sextcall_divls_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_divls_step_intro
      x y z
      (Hxz: Val.divls x y = Some z)
      m :
      sextcall_divls_step (x :: y :: nil) m z m
  .
  ...
  Inductive sextcall_divlu_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_divlu_step_intro
      x y z
      (Hxz: Val.divlu x y = Some z)
      m :
      sextcall_divlu_step (x :: y :: nil) m z m
  .
  ...
  Inductive sextcall_modls_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_modls_step_intro
      x y z
      (Hxz: Val.modls x y = Some z)
      m :
      sextcall_modls_step (x :: y :: nil) m z m
  .
  ...
  Inductive sextcall_modlu_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_modlu_step_intro
      x y z
      (Hxz: Val.modlu x y = Some z)
      m :
      sextcall_modlu_step (x :: y :: nil) m z m
  .
  ...
  Inductive sextcall_shll_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_shll_step_intro
      x y z
      (Hxz: Val.shll x y = z)
      m :
      sextcall_shll_step (x :: y :: nil) m z m
  .
  ...
  Inductive sextcall_shrlu_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_shrlu_step_intro
      x y z
      (Hxz: Val.shrlu x y = z)
      m :
      sextcall_shrlu_step (x :: y :: nil) m z m
  .
  ...
  Inductive sextcall_shrl_step:
    list val -> mwd D -> val -> mwd D -> Prop :=
  | sextcall_shrl_step_intro
      x y z
      (Hxz: Val.shrl x y = z)
      m :
      sextcall_shrl_step (x :: y :: nil) m z m
  .
  ...
  (** Prove that any OK layer [L ≥ L64] yields a correct
    [ExternalCallI64helpers].*)

  (** We guarantee that I64 helpers have a well-defined (and correct)
    semantics only if the global environment has the required shape
    (as specified in [stencil_matches]). To this end, we specified the
    [GenvValidOps] and [GenvValid] classes, which we now need to
    instantiate accordingly. *)

  Global Instance stencil_matches_genv_valid_ops:
    GenvValidOps :=
    {
      genv_valid F V ge := stencil_matches ge
    }.

  Global Instance stencil_matches_genv_valid:
    GenvValid (genv_valid_ops := stencil_matches_genv_valid_ops).
  Proof.
    constructor.
    - simpl.
      intros.
  ...
  Theorem L64_correct:
    forall L, L64 ≤ L ->
              LayerOK L ->
              ExternalCallI64Helpers
                (genv_valid_ops := stencil_matches_genv_valid_ops)
                (CompCertBuiltins.external_functions_sem
                   (ExternalCallsOpsX := compatlayer_extcall_ops_x L))
                hf.
  Proof.
