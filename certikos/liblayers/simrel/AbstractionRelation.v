...
Section WITH_MEMORY_MODEL.
  ...
  Definition abrel_new_glbl_invariant D1 D2 (R: abrel D1 D2) m1 m2 :=
    forall i init b ofs k p,
  ...
  Record abrel_match_mem D1 D2 (R: abrel D1 D2) m1 d1 m2 d2 :=
    {
      ...
      abrel_match_mem_perms:
        abrel_new_glbl_invariant D1 D2 R m1 m2;
  ...
  Proof.
    ...
    - red.
      intros.
      specialize (abrel_match_mem_perms0 _ _ _ ofs k p0 H2 H3).
