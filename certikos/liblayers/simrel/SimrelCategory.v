...
Section IDENTITY.
  ...
  Local Instance simrel_id_corefl:
    CoreflexiveInjection D D simrel_id_ops.
  Proof.
    split.
    - reflexivity.
    - reflexivity.
  ...
  Local Instance simrel_id_prf:
    CoreflexiveSimulationRelation D D simrel_id_ops.
  Proof.
    ...
    (** [Mem.free] *)
    - repeat rstep; subst.
      destruct (Mem.free _ _ _ _); constructor.
      exists w; repeat constructor.
    ...
    (** [Mem.store] *)
    - repeat rstep; subst.
      destruct (Mem.store _ _ _ _ _); constructor.
      exists w; repeat constructor.
    ...
    (** [Mem.storebytes] *)
    - repeat rstep; subst.
      apply coreflexivity in H1; subst.
      destruct (Mem.storebytes _ _ _ _); constructor.
      exists w; repeat constructor.
