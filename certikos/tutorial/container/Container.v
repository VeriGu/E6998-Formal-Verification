...
Section Container.
  ...
  Section AbsData.
    ...
    Program Definition container_layerdata : layerdata :=
      {|
  ...
  Section Code.
    ...
    Definition f_container_init := {|
      ...
      fn_body :=
        (Ssequence
          (Scall None (Evar boot_init (Tfunction Ctypes.Tnil tvoid cc_default)) nil)
          (Scall None
            ...
            ((Econst_int (Int.repr 0) tuint) ::
             (Ebinop Odiv
               (Ebinop Osub (Econst_int (Int.repr VM_USERHI) tuint)
                 (Econst_int (Int.repr VM_USERLO) tuint) tuint)
               (Econst_int (Int.repr PAGE_SIZE) tuint) tuint) ::
    ...
    Definition f_container_can_consume := {|
      fn_return := tuint;
      fn_callconv := cc_default;
      fn_params := (ccc_id, tuint) :: (ccc_n, tuint) :: nil;
      fn_vars := nil;
      fn_temps := (ccc_quota, tuint) :: (ccc_usage, tuint) :: (ccc_ret, tuint) :: nil;
      fn_body :=
        (Ssequence
          (Scall (Some ccc_quota)
            (Evar container_get_quota (Tfunction (Ctypes.Tcons tuint Ctypes.Tnil) tuint
                                       cc_default))
            ((Etempvar ccc_id tuint) :: nil))
          (Ssequence
            (Scall (Some ccc_usage)
              (Evar container_get_usage (Tfunction (Ctypes.Tcons tuint Ctypes.Tnil) tuint
                                         cc_default))
              ((Etempvar ccc_id tuint) :: nil))
            (Ssequence
              (Sifthenelse (Ebinop Ole (Etempvar ccc_n tuint) (Etempvar ccc_quota tuint)
                            tint)
                (Sset ccc_ret
                  (Ecast
                    (Ebinop Ole (Etempvar ccc_usage tuint)
                      (Ebinop Osub (Etempvar ccc_quota tuint) (Etempvar ccc_n tuint) tuint)
                      tint) tuint))
                (Sset ccc_ret (Econst_int (Int.repr 0) tuint)))
              (Sifthenelse (Etempvar ccc_ret tuint)
    ...
    Definition f_container_alloc := {|
      fn_return := tuint;
      fn_callconv := cc_default;
      fn_params := (ca_id, tuint) :: nil;
      fn_vars := nil;
      fn_temps := (ca_quota, tuint) :: (ca_usage, tuint) :: nil;
      fn_body :=
        (Ssequence
          (Scall (Some ca_quota)
            (Evar container_get_quota (Tfunction (Ctypes.Tcons tuint Ctypes.Tnil) tuint
                                       cc_default))
            ((Etempvar ca_id tuint) :: nil))
          (Ssequence
            (Scall (Some ca_usage)
              (Evar container_get_usage (Tfunction (Ctypes.Tcons tuint Ctypes.Tnil) tuint
                                         cc_default))
              ((Etempvar ca_id tuint) :: nil))
            (Sifthenelse (Ebinop Olt (Etempvar ca_usage tuint) (Etempvar ca_quota tuint)
                           tint)
              (Ssequence
                (Scall None
                  (Evar container_set_usage (Tfunction
                                              (Ctypes.Tcons tuint (Ctypes.Tcons tuint Ctypes.Tnil)) tvoid
                                              cc_default))
                  ((Etempvar ca_id tuint) ::
                   (Ebinop Oadd (Etempvar ca_usage tuint)
    ...
    Definition f_container_split := {|
      fn_return := tuint;
      fn_callconv := cc_default;
      fn_params := (cs_id, tuint) :: (cs_quota, tuint) :: nil;
      fn_vars := nil;
      fn_temps := (cs_nchildren, tuint) :: (cs_usage, tuint) ::
                  (cs_child_id, tuint) :: nil;
      fn_body :=
        (Ssequence
          (Scall (Some cs_nchildren)
            (Evar container_get_nchildren (Tfunction (Ctypes.Tcons tuint Ctypes.Tnil) tuint
                                            cc_default))
            ((Etempvar cs_id tuint) :: nil))
          (Ssequence
            (Scall (Some cs_usage)
              (Evar container_get_usage (Tfunction (Ctypes.Tcons tuint Ctypes.Tnil) tuint
                                          cc_default))
            ...
            (Ssequence
              (Sset cs_child_id
                (Ebinop Oadd
                  (Ebinop Oadd
                    (Ebinop Omul (Etempvar cs_id tuint) (Econst_int (Int.repr MAX_CHILDREN) tint)
                      tuint) (Econst_int (Int.repr 1) tint) tuint)
                  (Etempvar cs_nchildren tuint) tuint))
              (Ssequence
                (Scall None
                  (Evar container_node_init (Tfunction
                                              (Ctypes.Tcons tuint
                                                (Ctypes.Tcons tuint (Ctypes.Tcons tuint Ctypes.Tnil)))
                                              tvoid cc_default))
                  ((Etempvar cs_child_id tuint) :: (Etempvar cs_quota tuint) ::
                   (Etempvar cs_id tuint) :: nil))
                (Ssequence
                  (Scall None
                    (Evar container_set_usage (Tfunction
                                                (Ctypes.Tcons tuint (Ctypes.Tcons tuint Ctypes.Tnil))
                                                tvoid cc_default))
                    ((Etempvar cs_id tuint) ::
                     (Ebinop Oadd (Etempvar cs_usage tuint) (Etempvar cs_quota tuint)
                       tuint) :: nil))
                  (Ssequence
                    (Scall None
                      (Evar container_set_nchildren (Tfunction
                                                       (Ctypes.Tcons tuint (Ctypes.Tcons tuint Ctypes.Tnil))
                                                       tvoid cc_default))
                      ((Etempvar cs_id tuint) :: (Etempvar cs_child_id tuint) :: nil))
                    (Sreturn (Some (Etempvar cs_child_id tuint)))))))))
    |}.

    Program Definition inlinable_f_container_split : function :=
      inline f_container_split _.

    Definition Minit : cmodule := container_init ↦ inlinable_f_container_init.
    Definition Mconsume : cmodule := container_can_consume ↦ inlinable_f_container_can_consume.
    Definition Malloc : cmodule := container_alloc ↦ inlinable_f_container_alloc.
    Definition Msplit : cmodule := container_split ↦ inlinable_f_container_split.
